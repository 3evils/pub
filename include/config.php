...
$INSTALLER09['cookie_domain'] = '.3evils.net'; // set to eg: .somedomain.com or is subdomain set to: .sub.somedomain.com
$INSTALLER09['domain'] = '3evils.net';
//== Memcache expires
...
$INSTALLER09['ocelot_prefix'] = 'http://3evils.net:'.TRACKER_PORT.'/';
